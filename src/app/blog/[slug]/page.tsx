  ...
  return (
    <div className="mx-auto max-w-3xl px-6 py-12 md:py-24 space-y-12">
      ...
      <div className="flex flex-col md:flex-row gap-12 items-start pt-8">
        ...
        <article className="prose prose-lg prose-gray max-w-none md:w-3/4 space-y-8 text-gray-800 leading-loose">
          ...
          <h2 className="text-2xl font-bold mt-12 mb-6">Minimalism as a Feature</h2>
          <p>
        ...
        <aside className="hidden md:block md:w-1/4 sticky top-24 space-y-8">
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500 font-medium">
              ...
              <li className="hover:text-gray-900 transition-colors"><a href="#">Minimalism as a Feature</a></li>
            </ul>
          </div>
          <div className="pt-6 border-t border-gray-100">
            <h4 className="text-sm font-bold text-gray-900 mb-4 uppercase tracking-wider">Share</h4>
            <div className="flex gap-4">
              <button className="text-gray-400 hover:text-blue-500 transition-colors">Twitter</button>
      ...
      <div className="mt-24 bg-gray-50 border border-gray-100 rounded-2xl p-8 flex items-start gap-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-600 text-sm leading-relaxed">
            Creator, Innovator, and Developer exploring the intersections of business and technology. Building products that matter.
          </p>
        </div>
      </div>
    </div>
